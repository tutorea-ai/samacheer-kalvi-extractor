...
class HistoryQA910Builder:
    ...
    def __init__(self):
        ...
        print(f"✅ History QA Builder (910) v2.0 initialized — model: {self.model}")
    ...
    def generate(self, text: str, metadata: dict) -> Optional[str]:
        ...
        disc_context = DISCIPLINE_CONTEXT.get("history", "")

        total_calls = 4
        print(f"      [History QA 910 v2] Generating: {lesson_title}")
        print(f"      [History QA 910 v2] 4 calls → 100 questions")
