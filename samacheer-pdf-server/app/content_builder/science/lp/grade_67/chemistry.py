...
Science-flavored for Chemistry: matter, states, properties, mixtures.

KEY DIFFERENCES FROM grade_910/chemistry.py:
...
DISCIPLINE_NOTES = SCIENCE_DISCIPLINE_NOTES_67["chemistry"]
SPARK_STYLES     = SCIENCE_SPARK_STYLES_67
ACTIVITY_MAP     = SCIENCE_ACTIVITY_MAP_67


class ChemistryLP67Builder:

    def __init__(self):
        self.client = anthropic.Anthropic(api_key=settings.ANTHROPIC_API_KEY)
        self.model  = settings.ANTHROPIC_MODEL
        print(f"✅ Chemistry LP Builder (67) v1.0 initialized — model: {self.model}")
    ...
    def generate(self, text: str, metadata: dict) -> Optional[str]:
        ...
        print(f"      [Chemistry LP 67 v1.0] Generating: {lesson_title}")
        print(f"      [Chemistry LP 67 v1.0] 9 API calls: 0a+0b+Preamble+Day1-4+Day5+Assessment")

        parts = []

        print(f"      [Chemistry LP 67] Call 0a/9: Section Extractor...")
        ...
        print(f"      [Chemistry LP 67] Call 0b/9: Day Allocator...")
        ...
        print(f"      [Chemistry LP 67] Call 1/9: Preamble...")
        ...
        for day_num in range(1, 5):
            print(f"      [Chemistry LP 67] Call {day_num+1}/9: Day {day_num}...")
        ...
        print(f"      [Chemistry LP 67] Call 6/9: Day 5...")
        ...
        print(f"      [Chemistry LP 67] Call 7/9: Assessment...")
        ...
        if not parts:
            return None
        combined = "\n\n".join(parts)
        print(f"      [Chemistry LP 67 v1.0] ✅ Complete — {len(parts)} parts, {len(combined)} chars")
        return combined
    ...
    def _call_section_extractor(self, text: str, lesson_title: str) -> Optional[dict]:
        try:
            prompt = f"""You are a STRICT TEXT EXTRACTOR for a Samacheer Kalvi Chemistry chapter (Class 6/7).
...
---"""
    ...
    def _call_day_allocator(self, sections: dict, lesson_title: str) -> Optional[dict]:
        try:
            prompt = f"""You are a DAY ALLOCATOR for a Class 6/7 Chemistry lesson plan.
...
---"""
    ...
    def _call_preamble(self, text, class_num, unit, lesson_title,
        ...
        try:
            ...
            prompt = f"""Generate ONLY the preamble of this Chemistry Lesson Plan for Class 6/7.
...
3-4 values — connect Chemistry to everyday life for Class 6/7
...
4 skills: Observation, Classification, Prediction, Communication
Age-appropriate for Class 6/7

<h2>Part 5: Teaching Aids</h2>
Textbook (with pages), board, chalk, beakers, spoons,
simple household objects for demos, notebooks
Chemistry-specific: safe household chemistry demos, classification charts
...
---"""
            ...
            print(f"❌ Chemistry LP 67 preamble error: {e}")
            return None
...
"""
            ...
            prompt = f"""Generate ONLY Day {day_num} of a Class 6/7 Chemistry Lesson Plan.
...
<p class="day-meta">Duration: 35 Minutes | Chemistry | Class {class_num} | {day_focus}</p>
...
<div class="day-block">
  ...
  <div class="time-block lp-section-opening">
    ...
    "[3-minute Science Spark — use {spark['style']} style.
     ...
     Real-life superpower application of today's chemistry concept.
  ...
  <div class="time-block lp-section-main">
    ...
    <div class="vocab-block">
      ...
      <table>
        ...
        <tbody>
          [4-5 key chemistry terms from today — simple meanings for Class 6/7.
    ...
    <div class="activity-block">
      ...
      <p>[Step by step. Based on today's chemistry content.
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <p>"[Why/How question requiring deeper thought — from today's chemistry]"</p>
  ...
  <div class="time-block lp-section-closing">
    ...
    <div class="board-work">
      ...
      1. [Key chemistry concept from today]<br/>
    ...
    <div class="homework-block">
      ...
      <div class="board-work">
        ...
        Option C: Make a flowchart or mind map showing today's chemistry concept<br/>
...
---"""
            ...
            print(f"❌ Chemistry LP 67 Day {day_num} error: {e}")
            return None
    ...
    def _call_day5(self, text, class_num, unit, lesson_title,
        ...
        try:
            ...
            prompt = f"""Generate ONLY Day 5 of the Chemistry Lesson Plan for Class 6/7.
...
<p class="day-meta">Duration: 35 Minutes | Chemistry | Class {class_num} | Evaluation Day</p>
...
<div class="day-block">
  ...
  <div class="time-block lp-section-main">
    ...
    <div class="board-work">
      ...
      10: [Key chemistry term from chapter]<br/>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <p>"Explain [key chemistry concept] and draw a diagram showing it."</p>
  ...
  <div class="time-block lp-section-closing">
    ...
    <p class="lp-teacher-says">"[Congratulate students. Name 2-3 specific things learned.
     Connect chemistry to everyday life. Encouraging for Class 6/7.]"</p>
    <div class="board-work">
...
---"""
            ...
            print(f"❌ Chemistry LP 67 Day 5 error: {e}")
            return None
    ...
    def _call_assessment(self, text, class_num, unit,
        ...
        try:
            ...
            prompt = f"""Generate ONLY the Assessment Summary for this Chemistry chapter (Class 6/7).
...
<div class="assessment-block">
  ...
  <table>
    ...
    <tbody>
      [5 rows — Day 1-5. Simple age-appropriate chemistry questions.
...
---"""
            ...
            print(f"❌ Chemistry LP 67 assessment error: {e}")
            return None
...
chemistry_lp_67_builder = ChemistryLP67Builder()